...
class Blackboard {
 public:
  ...
  explicit Blackboard(const std::string &proto_file_path):
    ...
    // fake_info_sub_ = nh.susbscribe<geometry_msgs::PoseStamped>("fake_info", 10, &Blackboard::FakeInfoCallback, this);
  ...
  void FakeInfoCallback(const geometry_msgs::PoseStamped::ConstPtr &fake_info) {
    enemy_pose_ = *fake_info;
  }
 ...
 private:
  void UpdateRobotPose() {
    ...
    robot_tf_pose.frame_id_ = "robot_0/base_link";
