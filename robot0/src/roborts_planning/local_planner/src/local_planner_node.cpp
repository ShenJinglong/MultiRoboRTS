...
LocalPlannerNode::LocalPlannerNode() :
    local_planner_nh_("~"),
    as_(local_planner_nh_, "/robot_0/local_planner_node_action", boost::bind(&LocalPlannerNode::ExcuteCB, this, _1), false),
...
roborts_common::ErrorInfo LocalPlannerNode::Init() {
  ...
  vel_pub_ = local_planner_nh_.advertise<roborts_msgs::TwistAccel>("/robot_0/cmd_vel_acc", 5);
